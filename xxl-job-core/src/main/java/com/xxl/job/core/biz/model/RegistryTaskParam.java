...
public class RegistryTaskParam implements Serializable {
    ...
    private String scheduleType = ScheduleType.CRON.name();            // 调度类型
    private String scheduleConf;            // 调度配置，值含义取决于调度类型
    private String misfireStrategy = MisfireStrategy.DO_NOTHING.name();            // 调度过期策略

    private String executorRouteStrategy = RouteStrategy.FIRST.name();    // 执行器路由策略
